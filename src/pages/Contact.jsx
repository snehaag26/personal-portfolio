      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 relative z-10 w-full max-w-5xl mx-auto" ref={revealRef}>
        ...
        <div className="text-center mb-16 reveal w-full flex justify-center">
          <h2 className="text-[15vw] leading-none font-serif font-black text-[var(--primary)] uppercase tracking-tighter whitespace-nowrap">
            <span className="text-[var(--highlight)] pulse-glow rounded-full inline-block text-[12vw]">✦ </span> Let's Talk <span className="text-[var(--highlight)] pulse-glow rounded-full inline-block text-[12vw]">✦</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full reveal" style={{ transitionDelay: '300ms' }}>
          ...
          {/* Instagram Card */}
          <a href="https://www.instagram.com/snehha_ag26/" target="_blank" rel="noopener noreferrer" className="w-[300px] h-[300px] group glass-card rounded-3xl p-8 flex flex-col items-center justify-center gap-4 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(222,149,150,0.25)] hover:border-[var(--highlight)] cursor-none">
          ...
          {/* GitHub Card */}
          <a href="https://github.com/snehaag26" target="_blank" rel="noopener noreferrer" className="w-[300px] h-[300px] group glass-card rounded-3xl p-8 flex flex-col items-center justify-center gap-4 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(222,149,150,0.25)] hover:border-[var(--highlight)] cursor-none">
            <div className="w-16 h-16 rounded-full bg-[var(--primary)]/10 flex items-center justify-center text-[var(--highlight)] group-hover:bg-[var(--highlight)] group-hover:text-white transition-colors duration-500">
              <svg className="w-7 h-7 fill-current" viewBox="0 0 24 24">
          ...
          {/* LinkedIn Card */}
          <a href="https://www.linkedin.com/in/sneha-agrawal-93a489295/" target="_blank" rel="noopener noreferrer" className="w-[300px] h-[300px] group glass-card rounded-3xl p-8 flex flex-col items-center justify-center gap-4 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(222,149,150,0.25)] hover:border-[var(--highlight)] cursor-none">
            <div className="w-16 h-16 rounded-full bg-[var(--primary)]/10 flex items-center justify-center text-[var(--highlight)] group-hover:bg-[var(--highlight)] group-hover:text-white transition-colors duration-500">
              <svg className="w-7 h-7 fill-current" viewBox="0 0 24 24">
          ...
          <a href="mailto:Sneha.ag2610@gmail.com" className=" w-[300px] h-[300px] group glass-card rounded-3xl flex flex-col items-center justify-center gap-4 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(222,149,150,0.25)] hover:border-[var(--highlight)] cursor-none">
            <div className="w-16 h-16 rounded-full bg-[var(--primary)]/10 flex items-center justify-center text-[var(--highlight)] group-hover:bg-[var(--highlight)] group-hover:text-white transition-colors duration-500" >
              <Mail size={28} />
            </div>
            <div className="text-center">
